...
import { Mail, Lock, Loader2, LogIn, ChevronLeft, ShieldCheck } from 'lucide-react';
    ...
    return (
        <div className="login-wrapper">
                    ...
                    <form onSubmit={handleSubmit} className="auth-form">
                        ...
                        <div className="auth-actions">
                            ...
                            <button
                                ...
                                className="submit-btn primary-glow"
                            >
            ...
            <style>{`
                ...
                .submit-btn:not(:disabled):hover { transform: translateY(-3px); box-shadow: 0 10px 25px rgba(251, 191, 36, 0.3); }
                ...
                @media (max-width: 480px) { .glass-panel { padding: 36px 24px; border-radius: 20px; } }
            `}</style>
        </div>
    );
};
